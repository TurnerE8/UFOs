// import the data frmo data.js
const tableData = data; 

// Reference the HTML table using d3
var tbody = d3.select("tbody"); 

// Begin building the table we want our data to be called into 
function buildTable(data) {
    // first thing we need to do is clear the data with the following function
    tbody.html("");
